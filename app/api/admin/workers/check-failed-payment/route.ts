...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    reportError(error, { route: "POST /api/admin/workers/check-failed-payment", extra: { orderId, transactionId } });
    trackServerEvent("system", "check_failed_payment_worker_failed", { orderId, transactionId });
