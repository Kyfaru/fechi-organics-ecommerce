...
export function AdminFooter() {
  return (
    <footer className="border-t border-(--green-800) dark:border-(--dark-border) bg-(--green-900) dark:bg-(--dark-surface) px-8 py-4 font-dm text-[12px] text-white/70 dark:text-(--dark-muted) flex items-center justify-between">
      ...
      <span>Build by <span className="flex gap-1"><Link href="https://kyfaru.com" target="_blank" rel="noopener noreferrer" className="flex gap-1"><Image src="logo/Kyfaru-Logo-Filled-07.png" alt="Kyfaru" width={100} height={100} className="object-contain w-8 h-8" /> Kyfaru</Link></span></span>
