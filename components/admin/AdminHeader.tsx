...
export function AdminHeader() {
  ...
  return (
    <header className="h-[72px] bg-white dark:bg-[--dark-surface] border-b border-[--neutral-200] dark:border-[--dark-border] shadow-[--e1] flex items-center px-6 gap-6 sticky top-0 z-20">
      {/* Greeting */}
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        <div className="w-9 h-9 rounded-full bg-[--green-800] text-white font-dm text-[14px] font-semibold flex items-center justify-center cursor-pointer select-none">
          W
        </div>
      </div>
    </header>
